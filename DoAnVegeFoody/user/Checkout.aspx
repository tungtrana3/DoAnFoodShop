<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="DoAnVegeFoody.user.Checkout" %>
...
<asp:Content ID="Content9" ContentPlaceHolderID="script" runat="server">
    <script>
